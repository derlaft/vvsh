...
Некоторое количество кода можно увидеть в [соседнем репозитории](https://github.com/derlaft/vvsh-demos). Также, [веб-памятник Эдуарду Хилю](http://khilmonument.ttyh.ru/) тоже написан на нём, хотя если в нём вынести часть кода в отдельные модули, будет намного опрятней.
